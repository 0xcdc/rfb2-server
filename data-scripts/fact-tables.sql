...
LOCK TABLES `ethnicity_translation` WRITE;
/*!40000 ALTER TABLE `ethnicity_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ethnicity_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `gender_translation` WRITE;
/*!40000 ALTER TABLE `gender_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `gender_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `income_level_translation` WRITE;
/*!40000 ALTER TABLE `income_level_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `income_level_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `militaryStatus_translation` WRITE;
/*!40000 ALTER TABLE `militaryStatus_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `militaryStatus_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `prompt_translation` WRITE;
/*!40000 ALTER TABLE `prompt_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `prompt_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `race_translation` WRITE;
/*!40000 ALTER TABLE `race_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `race_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `translation_table` WRITE;
/*!40000 ALTER TABLE `translation_table` DISABLE KEYS */;
INSERT INTO `translation_table` VALUES ('ethnicity'),('gender'),('income_level'),('militaryStatus'),('prompt'),('race'),('yes_no');
/*!40000 ALTER TABLE `translation_table` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `yes_no_translation` WRITE;
/*!40000 ALTER TABLE `yes_no_translation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `yes_no_translation` ENABLE KEYS */;
UNLOCK TABLES;
